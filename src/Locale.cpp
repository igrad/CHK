...
void Locale::InitDungeon() {
   ...
   doorNS_right_inside_part1Clip = {0, 21, 9, 22};
   doorNS_right_inside_part2Clip = {32, 21, 9, 22};
   doorNS_right_inside_doorClip = {10, 21, 22, 22};
   doorNS_left_inside_part1Clip = {0, 21, 9, 22};
   doorNS_left_inside_part2Clip = {32, 21, 9, 22};
   doorNS_left_inside_doorClip = {10, 21, 22, 22};
   doorNS_right_outside_part1Clip = {0, 21, 9, 22};
   doorNS_right_outside_part2Clip = {32, 21, 9, 22};
   doorNS_right_outside_doorClip = {10, 21, 22, 22};
   doorNS_left_outside_part1Clip = {0, 21, 9, 22};
   doorNS_left_outside_part2Clip = {32, 21, 9, 22};
   doorNS_left_outside_doorClip = {10, 21, 22, 22};
